/*
 * pthreads_wrapper.c - Wrapper for selected pthreads functions
...
/*
 * wrapped_worker_func - Wrapper to put around start_routine function
 * passed by call to pthread_create.  Delays for random amount of time
 * and then calls original start_routine.
 */
void *wrapped_worker_func(void *param)
{
